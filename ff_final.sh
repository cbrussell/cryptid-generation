...
do
    ...
    ffmpeg -y -f image2 -framerate 24 -thread_queue_size 512 -i "${i}_%03d.png" -i ${i}_palette.png -filter_complex "[0]scale=750:-1:flags=lanczos[j];[j][1]paletteuse=new=1"  ../../gifs/"${i}".gif
