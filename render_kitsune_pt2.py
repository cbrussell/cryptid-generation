...
def worker_combine(color, combined_path):
    ...
    for i in range(1, 73):
        ...
        base_path_5 = Path(__file__).resolve().parents[1] / f"cryptid-generation/output/to_be_combined/tail_kitsune5_{color}/"
        base_path_4 = Path(__file__).resolve().parents[1] / f"cryptid-generation/output/to_be_combined/tail_kitsune4_{color}/"
        base_path_3 = Path(__file__).resolve().parents[1] / f"cryptid-generation/output/to_be_combined/tail_kitsune3_{color}/"
        base_path_2 = Path(__file__).resolve().parents[1] / f"cryptid-generation/output/to_be_combined/tail_kitsune2_{color}/"
        base_path_1 = Path(__file__).resolve().parents[1] / f"cryptid-generation/output/to_be_combined/tail_kitsune1_{color}/"
